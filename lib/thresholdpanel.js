...
const SystemMenuToggle = GObject.registerClass(
    class SystemMenuToggle extends QuickSettings.QuickMenuToggle {
        ...
        _updatePanelMenu() {
            ...
            this.menuItemFul.connect('activate', () => {
                Main.overview.hide();
            ...
            if (device[type][2] === '1') {
                this.menuItemBal.connect('activate', () => {
                    Main.overview.hide();
                    Main.panel.closeQuickSettings();
            ...
            this.menuItemMax.connect('activate', () => {
                Main.overview.hide();
                Main.panel.closeQuickSettings();
            ...
            if (device[type][1] === '1') {
                ...
                currentMode2Settings = this._settings.get_string('charging-mode');
                ...
                this.menuItem2Ful.connect('activate', () => {
                    Main.overview.hide();
                    Main.panel.closeQuickSettings();
                    Driver.setEndThresholdLimit(this._settings.get_int('current-full-capacity-end-threshold'));
                ...
                if (device[type][2] === '1') {
                    this.menuItem2Bal.connect('activate', () => {
                        Main.overview.hide();
                        Main.panel.closeQuickSettings();
                        Driver.setEndThresholdLimit(this._settings.get_int('current-balanced-end-threshold'));
                ...
                this.menuItem2Max.connect('activate', () => {
                    Main.overview.hide();
                    Main.panel.closeQuickSettings();
                    Driver.setEndThresholdLimit(this._settings.get_int('current-maxlife-end-threshold'));
                    if (device[type][0] === '1')
