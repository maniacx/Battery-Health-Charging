...
const ChargeLimitToggle = GObject.registerClass(
    class ChargeLimitToggle extends QuickSettings.QuickMenuToggle {
        ...
        _addForceDischargeToggle() {
            ...
            this._menuItemForceDischarge = new PopupMenu.PopupSwitchMenuItem(_('Force Discharge to threshold value'), menuItemForceDischargeState);
...
var ThresholdPanel = GObject.registerClass(
    class ThresholdPanel extends QuickSettings.SystemIndicator {
        constructor(settings, extensionObject, currentDevice, notifier) {
            ...
            this.quickSettingsItems.push(new ChargeLimitToggle(this._settings, this._extensionObject, this._device, this._notifier));
