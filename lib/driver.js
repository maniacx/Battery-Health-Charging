...
/*
 deviceArray = [0:haveStartThreshold, 1:haveDualBattery, 2:NoFixedThreshold(isVariable), 3:bat0FullIcon,
                 4:bat0BalIcon, 5:bat0MaxIcon]
 */
...
const LGXXXXX = ['1', '0', '0', 'ful100', '-none-', 'max080']; // 8
...
var deviceInfo = [null, DUALBAT, BAT1ESX, BAT0ESX, BAT1END, BAT0END, TOSHIBA, APP_INT,
    LGXXXXX, LENOVAX, SONYXXX, HUWAEIX, SAMSUNG, ACERXXX, BATCEND, BATTEND];
...
function isDeviceAuthRequired() {
    let type = ExtensionUtils.getSettings().get_int('device-type');
    switch (type) {
    case 1:
