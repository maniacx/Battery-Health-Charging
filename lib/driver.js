...
const deviceArray = [
    ...
    Thinkpad.ThinkpadDualBattery,                   // 13
    Thinkpad.ThinkpadSingleBatteryBAT0,             // 14
    Thinkpad.ThinkpadSingleBatteryBAT1,             // 15
    ThinkpadLegacy.ThinkpadLegacyDualBattery,       // 16
    ThinkpadLegacy.ThinkpadLegacySingleBatteryBAT0, // 17
    ThinkpadLegacy.ThinkpadLegacySingleBatteryBAT1, // 18
    Apple.AppleSingleBattery,                       // 19
    Acer.AcerSingleBattery,                         // 20
    Dell.DellSmBiosSingleBattery,                   // 21
    Msi.MsiSingleBattery,                           // 22
];
